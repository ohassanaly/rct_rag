...
data_path = Path('./builder/data')

pdf_data_path = Path('./builder/data/pdf')

img_data_path = Path('./builder/data/img')

pdf_extracted_summary_path = Path('./builder/data/summary.json')
acronym_path = Path('./builder/data/extracted_acronym_final.json')

process_text_path = data_path / "main.json"
